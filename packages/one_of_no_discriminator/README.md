# one_of_no_discriminator (EXPERIMENTAL)
...
dependencies:
  one_of_no_discriminator:
    path: /path/to/one_of_no_discriminator
```
...
```dart
import 'package:one_of_no_discriminator/one_of_no_discriminator.dart';
