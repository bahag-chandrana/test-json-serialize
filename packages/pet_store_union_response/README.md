# pet_store_union_response (EXPERIMENTAL)
...
```yaml
dependencies:
  pet_store_union_response: 1.0.0
```
...
dependencies:
  pet_store_union_response:
    path: /path/to/pet_store_union_response
```
...
```dart
import 'package:pet_store_union_response/pet_store_union_response.dart';
