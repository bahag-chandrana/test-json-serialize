...
/// @nodoc
mixin _$Apple {
  @JsonKey(name: r'cultivar')
  String? get cultivar => throw _privateConstructorUsedError;
  @JsonKey(name: r'origin')
...
class _$AppleCopyWithImpl<$Res, $Val extends Apple>
  ...
  @override
  $Res call({
    Object? cultivar = freezed,
    Object? origin = freezed,
  }) {
    return _then(_value.copyWith(
      cultivar: freezed == cultivar
          ? _value.cultivar
          : cultivar // ignore: cast_nullable_to_non_nullable
              as String?,
...
class _$AppleImpl extends _Apple {
  const _$AppleImpl(
      {@JsonKey(name: r'cultivar') this.cultivar,
      @JsonKey(name: r'origin') this.origin})
      : super._();
  ...
  @override
  String toString() {
    return 'Apple(cultivar: $cultivar, origin: $origin)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.cultivar, cultivar) ||
                other.cultivar == cultivar) &&
            (identical(other.origin, origin) || other.origin == origin));
  }

  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, cultivar, origin);
...
abstract class _Apple extends Apple {
  const factory _Apple(
      {@JsonKey(name: r'cultivar') final String? cultivar,
      @JsonKey(name: r'origin') final String? origin}) = _$AppleImpl;
...
/// @nodoc
mixin _$Banana {
  @JsonKey(name: r'lengthCm')
  num? get lengthCm => throw _privateConstructorUsedError;

  /// Serializes this Banana to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of Banana
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
...
abstract class $BananaCopyWith<$Res> {
  ...
  @useResult
  $Res call({@JsonKey(name: r'lengthCm') num? lengthCm});
}
...
class _$BananaImpl extends _Banana {
  const _$BananaImpl({@JsonKey(name: r'lengthCm') this.lengthCm}) : super._();
  ...
  @override
  String toString() {
    return 'Banana(lengthCm: $lengthCm)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, lengthCm);
...
abstract class _Banana extends Banana {
  const factory _Banana({@JsonKey(name: r'lengthCm') final num? lengthCm}) =
      _$BananaImpl;
