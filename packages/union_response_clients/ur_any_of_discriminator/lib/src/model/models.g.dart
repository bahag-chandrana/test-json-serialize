...
_$FruitInlineDiscAnyOfImpl _$$FruitInlineDiscAnyOfImplFromJson(
        Map<String, dynamic> json) =>
...
Map<String, dynamic> _$$FruitInlineDiscAnyOfImplToJson(
        _$FruitInlineDiscAnyOfImpl instance) =>
    <String, dynamic>{
      'seeds': instance.seeds,
      'fruitType': instance.fruitType,
    };

_$FruitInlineDiscAnyOf1Impl _$$FruitInlineDiscAnyOf1ImplFromJson(
        Map<String, dynamic> json) =>
...
Map<String, dynamic> _$$FruitInlineDiscAnyOf1ImplToJson(
        _$FruitInlineDiscAnyOf1Impl instance) =>
    <String, dynamic>{
      'length': instance.length,
      'fruitType': instance.fruitType,
    };
