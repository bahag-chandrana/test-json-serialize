# ur_one_of_no_discriminator (EXPERIMENTAL)
...
```yaml
dependencies:
  ur_one_of_no_discriminator: 1.0.0
```
...
dependencies:
  ur_one_of_no_discriminator:
    path: /path/to/ur_one_of_no_discriminator
```
...
```dart
import 'package:ur_one_of_no_discriminator/ur_one_of_no_discriminator.dart';
