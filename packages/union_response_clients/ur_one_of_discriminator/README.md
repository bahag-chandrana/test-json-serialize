# ur_one_of_discriminator (EXPERIMENTAL)
...
dependencies:
  ur_one_of_discriminator:
    path: /path/to/ur_one_of_discriminator
```
...
```dart
import 'package:ur_one_of_discriminator/ur_one_of_discriminator.dart';
