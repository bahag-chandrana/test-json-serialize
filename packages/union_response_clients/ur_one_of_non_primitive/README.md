# ur_one_of_non_primitive (EXPERIMENTAL)
...
dependencies:
  ur_one_of_non_primitive:
    path: /path/to/ur_one_of_non_primitive
```
...
```dart
import 'package:ur_one_of_non_primitive/ur_one_of_non_primitive.dart';
