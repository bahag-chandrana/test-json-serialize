...
/// @nodoc
@JsonSerializable()
class _$_Child extends _Child {
  const _$_Child({@JsonKey(name: r'name') this.name}) : super._();
...
abstract class _Child extends Child {
  const factory _Child({@JsonKey(name: r'name') final String? name}) = _$_Child;
...
/// @nodoc
abstract class _$$ExampleAsChildCopyWith<$Res> {
  factory _$$ExampleAsChildCopyWith(
          _$ExampleAsChild value, $Res Function(_$ExampleAsChild) then) =
      __$$ExampleAsChildCopyWithImpl<$Res>;
  @useResult
...
/// @nodoc
class __$$ExampleAsChildCopyWithImpl<$Res>
    extends _$ExampleCopyWithImpl<$Res, _$ExampleAsChild>
    implements _$$ExampleAsChildCopyWith<$Res> {
  __$$ExampleAsChildCopyWithImpl(
      _$ExampleAsChild _value, $Res Function(_$ExampleAsChild) _then)
      : super(_value, _then);
...
class _$ExampleAsChild extends ExampleAsChild {
  const _$ExampleAsChild({required this.childValue}) : super._();
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$ExampleAsChildCopyWith<_$ExampleAsChild> get copyWith =>
      __$$ExampleAsChildCopyWithImpl<_$ExampleAsChild>(this, _$identity);
