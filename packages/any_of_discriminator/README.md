# any_of_discriminator (EXPERIMENTAL)
...
dependencies:
  any_of_discriminator:
    path: /path/to/any_of_discriminator
```
...
```dart
import 'package:any_of_discriminator/any_of_discriminator.dart';
