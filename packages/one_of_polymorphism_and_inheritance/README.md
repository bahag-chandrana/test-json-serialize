# one_of_polymorphism_and_inheritance (EXPERIMENTAL)
...
```yaml
dependencies:
  one_of_polymorphism_and_inheritance: 1.0.0
```
...
dependencies:
  one_of_polymorphism_and_inheritance:
    path: /path/to/one_of_polymorphism_and_inheritance
```
...
```dart
import 'package:one_of_polymorphism_and_inheritance/one_of_polymorphism_and_inheritance.dart';
