# one_of_array_map_import (EXPERIMENTAL)
...
dependencies:
  one_of_array_map_import:
    path: /path/to/one_of_array_map_import
```
...
```dart
import 'package:one_of_array_map_import/one_of_array_map_import.dart';
